...
static const int vcf_first_final = 675;
static const int vcf_error = 0;

static const int vcf_en_main = 1;
static const int vcf_en_main_meta_section = 20;
static const int vcf_en_main_body_section = 676;
static const int vcf_en_meta_section_skip = 673;
static const int vcf_en_body_section_skip = 674;


#line 603 "vcf_v41.ragel"
...
#line 50 "vcf_v41.ragel"
	...
	goto st0;
#line 1320 "vcf_validator_detail.hpp"
st0:
cs = 0;
	goto _out;
st2:
...
st15:
	if ( ++p == pe )
		goto _test_eof15;
case 15:
#line 1425 "vcf_validator_detail.hpp"
	if ( (*p) == 10 )
		goto tr16;
	if ( 33 <= (*p) && (*p) <= 126 )
		goto st15;
...
st16:
	if ( ++p == pe )
		goto _test_eof16;
case 16:
#line 1446 "vcf_validator_detail.hpp"
	if ( (*p) == 35 )
		goto tr19;
	goto tr18;
tr19:
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
#line 1461 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 35: goto st18;
		case 67: goto st473;
	}
...
st20:
	if ( ++p == pe )
		goto _test_eof20;
case 20:
#line 1636 "vcf_validator_detail.hpp"
	if ( (*p) == 35 )
		goto tr19;
	goto tr20;
tr25:
...
st22:
	if ( ++p == pe )
		goto _test_eof22;
case 22:
#line 1687 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st23;
	if ( (*p) > 59 ) {
		if ( 62 <= (*p) && (*p) <= 126 )
...
st27:
	if ( ++p == pe )
		goto _test_eof27;
case 27:
#line 1813 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 62: goto tr53;
		case 65: goto tr55;
...
st28:
	if ( ++p == pe )
		goto _test_eof28;
case 28:
#line 1861 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st29:
	if ( ++p == pe )
		goto _test_eof29;
case 29:
#line 1905 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr64;
		case 44: goto tr52;
		case 62: goto tr53;
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 1927 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st33:
	if ( ++p == pe )
		goto _test_eof33;
case 33:
#line 2031 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st44:
	if ( ++p == pe )
		goto _test_eof44;
case 44:
#line 2398 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st51:
	if ( ++p == pe )
		goto _test_eof51;
case 51:
#line 2629 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st55:
	if ( ++p == pe )
		goto _test_eof55;
case 55:
#line 2764 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st62:
	if ( ++p == pe )
		goto _test_eof62;
case 62:
#line 2995 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st67:
	if ( ++p == pe )
		goto _test_eof67;
case 67:
#line 3162 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr52;
		case 61: goto st25;
		case 62: goto tr53;
...
st76:
	if ( ++p == pe )
		goto _test_eof76;
case 76:
#line 3457 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 76: goto st77;
...
st79:
	if ( ++p == pe )
		goto _test_eof79;
case 79:
#line 3558 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 73: goto st80;
...
st87:
	if ( ++p == pe )
		goto _test_eof87;
case 87:
#line 3814 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 78: goto st88;
...
st90:
	if ( ++p == pe )
		goto _test_eof90;
case 90:
#line 3914 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 69: goto st91;
...
st101:
	if ( ++p == pe )
		goto _test_eof101;
case 101:
#line 4269 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 95: goto st24;
...
st108:
	if ( ++p == pe )
		goto _test_eof108;
case 108:
#line 4493 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 95: goto st24;
...
st113:
	if ( ++p == pe )
		goto _test_eof113;
case 113:
#line 4655 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 95: goto st24;
...
st122:
	if ( ++p == pe )
		goto _test_eof122;
case 122:
#line 4941 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 76: goto st123;
...
st169:
	if ( ++p == pe )
		goto _test_eof169;
case 169:
#line 5451 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 73: goto st170;
...
st352:
	if ( ++p == pe )
		goto _test_eof352;
case 352:
#line 7233 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 69: goto st353;
...
st366:
	if ( ++p == pe )
		goto _test_eof366;
case 366:
#line 7578 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 65: goto st367;
...
st415:
	if ( ++p == pe )
		goto _test_eof415;
case 415:
#line 8150 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 95: goto st21;
...
st430:
	if ( ++p == pe )
		goto _test_eof430;
case 430:
#line 8469 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 95: goto st21;
...
st454:
	if ( ++p == pe )
		goto _test_eof454;
case 454:
#line 8831 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 95: goto st21;
...
st517:
	if ( ++p == pe )
		goto _test_eof517;
case 517:
#line 9540 "vcf_validator_detail.hpp"
	if ( 32 <= (*p) && (*p) <= 126 )
		goto tr583;
	goto tr537;
tr583:
...
st518:
	if ( ++p == pe )
		goto _test_eof518;
case 518:
#line 9554 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr584;
		case 10: goto tr585;
	}
...
st675:
	if ( ++p == pe )
		goto _test_eof675;
case 675:
#line 9584 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto tr786;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st519:
	if ( ++p == pe )
		goto _test_eof519;
case 519:
#line 9611 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr588;
		case 59: goto st519;
		case 61: goto st519;
...
st520:
	if ( ++p == pe )
		goto _test_eof520;
case 520:
#line 9637 "vcf_validator_detail.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr591;
	goto tr590;
tr591:
...
st521:
	if ( ++p == pe )
		goto _test_eof521;
case 521:
#line 9651 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr592;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto st521;
...
st522:
	if ( ++p == pe )
		goto _test_eof522;
case 522:
#line 9673 "vcf_validator_detail.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr595;
	} else if ( (*p) >= 33 )
...
st523:
	if ( ++p == pe )
		goto _test_eof523;
case 523:
#line 9690 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr596;
		case 59: goto st672;
	}
...
st524:
	if ( ++p == pe )
		goto _test_eof524;
case 524:
#line 9712 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 65: goto tr600;
		case 67: goto tr600;
		case 71: goto tr600;
...
st525:
	if ( ++p == pe )
		goto _test_eof525;
case 525:
#line 9736 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr601;
		case 65: goto st525;
		case 67: goto st525;
...
st526:
	if ( ++p == pe )
		goto _test_eof526;
case 526:
#line 9765 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 42: goto tr604;
		case 46: goto tr605;
		case 48: goto tr606;
...
st527:
	if ( ++p == pe )
		goto _test_eof527;
case 527:
#line 9795 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr611;
	goto tr603;
tr611:
...
st528:
	if ( ++p == pe )
		goto _test_eof528;
case 528:
#line 9871 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr613;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr614;
...
st532:
	if ( ++p == pe )
		goto _test_eof532;
case 532:
#line 9981 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr622;
		case 59: goto st531;
	}
...
st533:
	if ( ++p == pe )
		goto _test_eof533;
case 533:
#line 10003 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr624;
		case 49: goto tr626;
		case 65: goto tr627;
...
st534:
	if ( ++p == pe )
		goto _test_eof534;
case 534:
#line 10038 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st535:
	if ( ++p == pe )
		goto _test_eof535;
case 535:
#line 10060 "vcf_validator_detail.hpp"
	if ( (*p) == 71 )
		goto tr642;
	goto tr641;
tr642:
...
st538:
	if ( ++p == pe )
		goto _test_eof538;
case 538:
#line 10111 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr647;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr647;
...
st539:
	if ( ++p == pe )
		goto _test_eof539;
case 539:
#line 10127 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr648;
		case 10: goto tr649;
		case 47: goto st543;
...
st676:
	if ( ++p == pe )
		goto _test_eof676;
case 676:
#line 10210 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto tr786;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st540:
	if ( ++p == pe )
		goto _test_eof540;
case 540:
#line 10237 "vcf_validator_detail.hpp"
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
			goto st541;
	} else if ( (*p) > 61 ) {
...
st549:
	if ( ++p == pe )
		goto _test_eof549;
case 549:
#line 10361 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st559:
	if ( ++p == pe )
		goto _test_eof559;
case 559:
#line 10534 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st574:
	if ( ++p == pe )
		goto _test_eof574;
case 574:
#line 10751 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st585:
	if ( ++p == pe )
		goto _test_eof585;
case 585:
#line 10955 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st586:
	if ( ++p == pe )
		goto _test_eof586;
case 586:
#line 10984 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st588:
	if ( ++p == pe )
		goto _test_eof588;
case 588:
#line 11033 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st589:
	if ( ++p == pe )
		goto _test_eof589;
case 589:
#line 11066 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st591:
	if ( ++p == pe )
		goto _test_eof591;
case 591:
#line 11112 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st592:
	if ( ++p == pe )
		goto _test_eof592;
case 592:
#line 11140 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st548;
...
st606:
	if ( ++p == pe )
		goto _test_eof606;
case 606:
#line 11449 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr622;
		case 58: goto st531;
	}
...
st612:
	if ( ++p == pe )
		goto _test_eof612;
case 612:
#line 11562 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr719;
	goto tr603;
tr607:
...
st613:
	if ( ++p == pe )
		goto _test_eof613;
case 613:
#line 11576 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 67: goto st617;
		case 68: goto st620;
		case 73: goto st637;
...
st639:
	if ( ++p == pe )
		goto _test_eof639;
case 639:
#line 11959 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr719;
		case 44: goto st640;
		case 46: goto st642;
...
st665:
	if ( ++p == pe )
		goto _test_eof665;
case 665:
#line 12286 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st669;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st677:
	if ( ++p == pe )
		goto _test_eof677;
case 677:
#line 12390 "vcf_validator_detail.hpp"
	goto st0;
st674:
	if ( ++p == pe )
		goto _test_eof674;
...
st678:
	if ( ++p == pe )
		goto _test_eof678;
case 678:
#line 12412 "vcf_validator_detail.hpp"
	goto st0;
	}
...
#line 45 "vcf_v41.ragel"
	...
	break;
#line 14903 "vcf_validator_detail.hpp"
	}
	}
