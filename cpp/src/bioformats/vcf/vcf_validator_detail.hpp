...
st558:
	if ( ++p == pe )
		goto _test_eof558;
case 558:
#line 10374 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr645;
		case 59: goto st633;
	}
...
st559:
	if ( ++p == pe )
		goto _test_eof559;
case 559:
#line 10396 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr649;
		case 49: goto tr651;
		case 65: goto tr652;
...
st562:
	if ( ++p == pe )
		goto _test_eof562;
case 562:
#line 10478 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 45: goto st562;
		case 46: goto st563;
		case 95: goto st563;
...
st564:
	if ( ++p == pe )
		goto _test_eof564;
case 564:
#line 10545 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr676;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr676;
...
st565:
	if ( ++p == pe )
		goto _test_eof565;
case 565:
#line 10561 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr677;
		case 10: goto tr678;
		case 47: goto st569;
...
st566:
	if ( ++p == pe )
		goto _test_eof566;
case 566:
#line 10671 "vcf_validator_detail.hpp"
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
			goto st567;
	} else if ( (*p) > 61 ) {
...
st573:
	if ( ++p == pe )
		goto _test_eof573;
case 573:
#line 10755 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 45: goto st563;
		case 46: goto st573;
		case 95: goto st563;
...
st574:
	if ( ++p == pe )
		goto _test_eof574;
case 574:
#line 10780 "vcf_validator_detail.hpp"
	if ( (*p) == 95 )
		goto st574;
	if ( (*p) < 48 ) {
		if ( 45 <= (*p) && (*p) <= 46 )
...
st586:
	if ( ++p == pe )
		goto _test_eof586;
case 586:
#line 11006 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st605:
	if ( ++p == pe )
		goto _test_eof605;
case 605:
#line 11288 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st612:
	if ( ++p == pe )
		goto _test_eof612;
case 612:
#line 11427 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st613:
	if ( ++p == pe )
		goto _test_eof613;
case 613:
#line 11456 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st616:
	if ( ++p == pe )
		goto _test_eof616;
case 616:
#line 11538 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st618:
	if ( ++p == pe )
		goto _test_eof618;
case 618:
#line 11584 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st619:
	if ( ++p == pe )
		goto _test_eof619;
case 619:
#line 11612 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st625:
	if ( ++p == pe )
		goto _test_eof625;
case 625:
#line 11746 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr662;
		case 10: goto tr663;
		case 59: goto st575;
...
st637:
	if ( ++p == pe )
		goto _test_eof637;
case 637:
#line 11965 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr747;
		case 65: goto st638;
		case 67: goto st638;
...
st639:
	if ( ++p == pe )
		goto _test_eof639;
case 639:
#line 12008 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr747;
	goto tr630;
tr634:
...
st640:
	if ( ++p == pe )
		goto _test_eof640;
case 640:
#line 12022 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 45: goto st641;
		case 46: goto st644;
		case 67: goto st645;
...
st668:
	if ( ++p == pe )
		goto _test_eof668;
case 668:
#line 12440 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr747;
		case 44: goto st669;
		case 46: goto st671;
...
st686:
	if ( ++p == pe )
		goto _test_eof686;
case 686:
#line 12666 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st691;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st694:
	if ( ++p == pe )
		goto _test_eof694;
case 694:
#line 12767 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st698;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st706:
	if ( ++p == pe )
		goto _test_eof706;
case 706:
#line 12871 "vcf_validator_detail.hpp"
	goto st0;
st703:
	if ( ++p == pe )
		goto _test_eof703;
...
st707:
	if ( ++p == pe )
		goto _test_eof707;
case 707:
#line 12893 "vcf_validator_detail.hpp"
	goto st0;
	}
...
#line 45 "vcf_v41.ragel"
	...
	break;
#line 15404 "vcf_validator_detail.hpp"
	}
	}
