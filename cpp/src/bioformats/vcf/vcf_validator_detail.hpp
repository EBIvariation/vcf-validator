...
static const int vcf_first_final = 673;
static const int vcf_error = 0;

static const int vcf_en_main = 1;
static const int vcf_en_main_meta_section = 20;
static const int vcf_en_main_body_section = 674;
static const int vcf_en_meta_section_skip = 671;
static const int vcf_en_body_section_skip = 672;


#line 588 "vcf_v41.ragel"
...
st264:
	if ( ++p == pe )
		goto _test_eof264;
case 264:
#line 6416 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 78: goto st265;
...
st352:
	if ( ++p == pe )
		goto _test_eof352;
case 352:
#line 7193 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 69: goto st353;
...
st366:
	if ( ++p == pe )
		goto _test_eof366;
case 366:
#line 7538 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 65: goto st367;
...
st415:
	if ( ++p == pe )
		goto _test_eof415;
case 415:
#line 8110 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 95: goto st21;
...
st454:
	if ( ++p == pe )
		goto _test_eof454;
case 454:
#line 8791 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr38;
		case 95: goto st21;
...
st517:
	if ( ++p == pe )
		goto _test_eof517;
case 517:
#line 9500 "vcf_validator_detail.hpp"
	if ( 32 <= (*p) && (*p) <= 126 )
		goto tr583;
	goto tr537;
tr583:
...
st518:
	if ( ++p == pe )
		goto _test_eof518;
case 518:
#line 9514 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr584;
		case 10: goto tr585;
	}
...
st519:
	if ( ++p == pe )
		goto _test_eof519;
case 519:
#line 9571 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr588;
		case 59: goto st519;
		case 61: goto st519;
...
st520:
	if ( ++p == pe )
		goto _test_eof520;
case 520:
#line 9597 "vcf_validator_detail.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr591;
	goto tr590;
tr591:
...
st522:
	if ( ++p == pe )
		goto _test_eof522;
case 522:
#line 9633 "vcf_validator_detail.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr595;
	} else if ( (*p) >= 33 )
...
st524:
	if ( ++p == pe )
		goto _test_eof524;
case 524:
#line 9672 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 65: goto tr600;
		case 67: goto tr600;
		case 71: goto tr600;
...
st525:
	if ( ++p == pe )
		goto _test_eof525;
case 525:
#line 9696 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr601;
		case 65: goto st525;
		case 67: goto st525;
...
st526:
	if ( ++p == pe )
		goto _test_eof526;
case 526:
#line 9725 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 42: goto tr604;
		case 46: goto tr605;
		case 48: goto tr606;
...
st527:
	if ( ++p == pe )
		goto _test_eof527;
case 527:
#line 9755 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr611;
	goto tr603;
tr611:
...
st528:
	if ( ++p == pe )
		goto _test_eof528;
case 528:
#line 9831 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr613;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr614;
...
st531:
	if ( ++p == pe )
		goto _test_eof531;
case 531:
#line 9907 "vcf_validator_detail.hpp"
	if ( (*p) == 58 )
		goto st531;
	if ( (*p) < 65 ) {
		if ( (*p) < 48 ) {
...
st532:
	if ( ++p == pe )
		goto _test_eof532;
case 532:
#line 9941 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr622;
		case 59: goto st531;
	}
...
st533:
	if ( ++p == pe )
		goto _test_eof533;
case 533:
#line 9963 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr624;
		case 49: goto tr626;
		case 65: goto tr627;
...
st534:
	if ( ++p == pe )
		goto _test_eof534;
case 534:
#line 9998 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st535:
	if ( ++p == pe )
		goto _test_eof535;
case 535:
#line 10020 "vcf_validator_detail.hpp"
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
			goto tr642;
	} else if ( (*p) > 90 ) {
...
st536:
	if ( ++p == pe )
		goto _test_eof536;
case 536:
#line 10040 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr643;
		case 58: goto st545;
	}
...
st537:
	if ( ++p == pe )
		goto _test_eof537;
case 537:
#line 10078 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr647;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr647;
...
st538:
	if ( ++p == pe )
		goto _test_eof538;
case 538:
#line 10094 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr648;
		case 10: goto tr649;
		case 47: goto st542;
...
st572:
	if ( ++p == pe )
		goto _test_eof572;
case 572:
#line 10701 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st583:
	if ( ++p == pe )
		goto _test_eof583;
case 583:
#line 10905 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st584:
	if ( ++p == pe )
		goto _test_eof584;
case 584:
#line 10934 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st586:
	if ( ++p == pe )
		goto _test_eof586;
case 586:
#line 10983 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st590:
	if ( ++p == pe )
		goto _test_eof590;
case 590:
#line 11090 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st596:
	if ( ++p == pe )
		goto _test_eof596;
case 596:
#line 11224 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr637;
		case 10: goto tr638;
		case 59: goto st546;
...
st605:
	if ( ++p == pe )
		goto _test_eof605;
case 605:
#line 11435 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr615;
		case 46: goto st606;
	}
...
st608:
	if ( ++p == pe )
		goto _test_eof608;
case 608:
#line 11469 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr716;
		case 65: goto st609;
		case 67: goto st609;
...
st611:
	if ( ++p == pe )
		goto _test_eof611;
case 611:
#line 11526 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 67: goto st615;
		case 68: goto st618;
		case 73: goto st635;
...
st637:
	if ( ++p == pe )
		goto _test_eof637;
case 637:
#line 11909 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr716;
		case 44: goto st638;
		case 46: goto st640;
...
st655:
	if ( ++p == pe )
		goto _test_eof655;
case 655:
#line 12135 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st660;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st663:
	if ( ++p == pe )
		goto _test_eof663;
case 663:
#line 12236 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st667;
	if ( (*p) < 59 ) {
		if ( 33 <= (*p) && (*p) <= 57 )
...
st675:
	if ( ++p == pe )
		goto _test_eof675;
case 675:
#line 12340 "vcf_validator_detail.hpp"
	goto st0;
st672:
	if ( ++p == pe )
		goto _test_eof672;
...
st676:
	if ( ++p == pe )
		goto _test_eof676;
case 676:
#line 12362 "vcf_validator_detail.hpp"
	goto st0;
	}
...
#line 45 "vcf_v41.ragel"
	...
	break;
#line 14811 "vcf_validator_detail.hpp"
	}
	}
