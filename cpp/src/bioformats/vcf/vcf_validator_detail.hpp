...
static const int vcf_first_final = 674;
static const int vcf_error = 0;

static const int vcf_en_main = 1;
static const int vcf_en_main_meta_section = 20;
static const int vcf_en_main_body_section = 675;
static const int vcf_en_meta_section_skip = 672;
...
st20:
	if ( ++p == pe )
		goto _test_eof20;
case 20:
#line 846 "vcf_validator_detail.hpp"
	if ( (*p) == 35 )
		goto tr19;
	goto tr20;
tr25:
...
st21:
	if ( ++p == pe )
		goto _test_eof21;
case 21:
#line 860 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 95: goto st21;
...
st22:
	if ( ++p == pe )
		goto _test_eof22;
case 22:
#line 897 "vcf_validator_detail.hpp"
	if ( (*p) == 60 )
		goto st23;
	if ( (*p) > 59 ) {
		if ( 62 <= (*p) && (*p) <= 126 )
...
st24:
	if ( ++p == pe )
		goto _test_eof24;
case 24:
#line 956 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 95: goto st24;
...
st27:
	if ( ++p == pe )
		goto _test_eof27;
case 27:
#line 1023 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 62: goto tr54;
		case 65: goto tr56;
...
st28:
	if ( ++p == pe )
		goto _test_eof28;
case 28:
#line 1071 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 61: goto st25;
		case 62: goto tr54;
...
st29:
	if ( ++p == pe )
		goto _test_eof29;
case 29:
#line 1115 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr65;
		case 44: goto tr53;
		case 62: goto tr54;
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 1137 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 61: goto st25;
		case 62: goto tr54;
...
st44:
	if ( ++p == pe )
		goto _test_eof44;
case 44:
#line 1608 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 61: goto st25;
		case 62: goto tr54;
...
st55:
	if ( ++p == pe )
		goto _test_eof55;
case 55:
#line 1974 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 61: goto st25;
		case 62: goto tr54;
...
st62:
	if ( ++p == pe )
		goto _test_eof62;
case 62:
#line 2205 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 61: goto st25;
		case 62: goto tr54;
...
st67:
	if ( ++p == pe )
		goto _test_eof67;
case 67:
#line 2372 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr53;
		case 61: goto st25;
		case 62: goto tr54;
...
st76:
	if ( ++p == pe )
		goto _test_eof76;
case 76:
#line 2667 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 76: goto st77;
...
st79:
	if ( ++p == pe )
		goto _test_eof79;
case 79:
#line 2768 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 73: goto st80;
...
st87:
	if ( ++p == pe )
		goto _test_eof87;
case 87:
#line 3024 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 78: goto st88;
...
st90:
	if ( ++p == pe )
		goto _test_eof90;
case 90:
#line 3124 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 69: goto st91;
...
st97:
	if ( ++p == pe )
		goto _test_eof97;
case 97:
#line 3348 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 65: goto st98;
...
st101:
	if ( ++p == pe )
		goto _test_eof101;
case 101:
#line 3479 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 95: goto st24;
...
st108:
	if ( ++p == pe )
		goto _test_eof108;
case 108:
#line 3703 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto st25;
		case 95: goto st24;
...
st122:
	if ( ++p == pe )
		goto _test_eof122;
case 122:
#line 4151 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 76: goto st123;
...
st169:
	if ( ++p == pe )
		goto _test_eof169;
case 169:
#line 4678 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 73: goto st170;
...
st268:
	if ( ++p == pe )
		goto _test_eof268;
case 268:
#line 5779 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 78: goto st269;
...
st367:
	if ( ++p == pe )
		goto _test_eof367;
case 367:
#line 6843 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 69: goto st368;
...
st388:
	if ( ++p == pe )
		goto _test_eof388;
case 388:
#line 7304 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 65: goto st389;
...
st444:
	if ( ++p == pe )
		goto _test_eof444;
case 444:
#line 8241 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 95: goto st21;
...
st475:
	if ( ++p == pe )
		goto _test_eof475;
case 475:
#line 8864 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 10: goto tr35;
		case 61: goto tr39;
		case 95: goto st21;
...
st533:
	if ( ++p == pe )
		goto _test_eof533;
case 533:
#line 9524 "vcf_validator_detail.hpp"
	if ( 32 <= (*p) && (*p) <= 126 )
		goto tr561;
	goto tr515;
tr561:
...
st534:
	if ( ++p == pe )
		goto _test_eof534;
case 534:
#line 9538 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr562;
		case 10: goto tr563;
	}
...
st535:
	if ( ++p == pe )
		goto _test_eof535;
case 535:
#line 9590 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr566;
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
...
st536:
	if ( ++p == pe )
		goto _test_eof536;
case 536:
#line 9613 "vcf_validator_detail.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr569;
	goto tr568;
tr569:
...
st537:
	if ( ++p == pe )
		goto _test_eof537;
case 537:
#line 9627 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr570;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto st537;
...
st538:
	if ( ++p == pe )
		goto _test_eof538;
case 538:
#line 9649 "vcf_validator_detail.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr573;
	} else if ( (*p) >= 33 )
...
st539:
	if ( ++p == pe )
		goto _test_eof539;
case 539:
#line 9666 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr574;
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
...
st540:
	if ( ++p == pe )
		goto _test_eof540;
case 540:
#line 9689 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 65: goto tr577;
		case 67: goto tr577;
		case 71: goto tr577;
...
st541:
	if ( ++p == pe )
		goto _test_eof541;
case 541:
#line 9713 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr578;
		case 65: goto st541;
		case 67: goto st541;
...
st543:
	if ( ++p == pe )
		goto _test_eof543;
case 543:
#line 9772 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr588;
	goto tr580;
tr588:
...
st544:
	if ( ++p == pe )
		goto _test_eof544;
case 544:
#line 9848 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr590;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr591;
...
st545:
	if ( ++p == pe )
		goto _test_eof545;
case 545:
#line 9864 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr592;
	goto tr589;
tr592:
...
st547:
	if ( ++p == pe )
		goto _test_eof547;
case 547:
#line 9905 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr595;
		case 59: goto st618;
	}
...
st548:
	if ( ++p == pe )
		goto _test_eof548;
case 548:
#line 9927 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr599;
		case 49: goto tr601;
		case 65: goto tr602;
...
st549:
	if ( ++p == pe )
		goto _test_eof549;
case 549:
#line 9962 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st552:
	if ( ++p == pe )
		goto _test_eof552;
case 552:
#line 10032 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr622;
		case 46: goto st552;
		case 58: goto st558;
...
st553:
	if ( ++p == pe )
		goto _test_eof553;
case 553:
#line 10072 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr625;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr625;
...
st675:
	if ( ++p == pe )
		goto _test_eof675;
case 675:
#line 10171 "vcf_validator_detail.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto tr748;
	} else if ( (*p) >= 33 )
...
st559:
	if ( ++p == pe )
		goto _test_eof559;
case 559:
#line 10232 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto st552;
		case 95: goto st559;
	}
...
st564:
	if ( ++p == pe )
		goto _test_eof564;
case 564:
#line 10329 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 48: goto st565;
...
st571:
	if ( ++p == pe )
		goto _test_eof571;
case 571:
#line 10457 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st586:
	if ( ++p == pe )
		goto _test_eof586;
case 586:
#line 10674 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st590:
	if ( ++p == pe )
		goto _test_eof590;
case 590:
#line 10739 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st597:
	if ( ++p == pe )
		goto _test_eof597;
case 597:
#line 10878 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st598:
	if ( ++p == pe )
		goto _test_eof598;
case 598:
#line 10907 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st600:
	if ( ++p == pe )
		goto _test_eof600;
case 600:
#line 10956 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st601:
	if ( ++p == pe )
		goto _test_eof601;
case 601:
#line 10989 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st604:
	if ( ++p == pe )
		goto _test_eof604;
case 604:
#line 11063 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr612;
		case 10: goto tr613;
		case 59: goto st560;
...
st619:
	if ( ++p == pe )
		goto _test_eof619;
case 619:
#line 11382 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr592;
		case 46: goto st620;
	}
...
st622:
	if ( ++p == pe )
		goto _test_eof622;
case 622:
#line 11416 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr693;
		case 44: goto st623;
		case 46: goto st622;
...
st624:
	if ( ++p == pe )
		goto _test_eof624;
case 624:
#line 11461 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr693;
	goto tr580;
tr584:
...
st625:
	if ( ++p == pe )
		goto _test_eof625;
case 625:
#line 11475 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto st626;
		case 67: goto st629;
		case 68: goto st632;
...
st652:
	if ( ++p == pe )
		goto _test_eof652;
case 652:
#line 11850 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr693;
		case 44: goto st623;
		case 46: goto st622;
...
st662:
	if ( ++p == pe )
		goto _test_eof662;
case 662:
#line 11956 "vcf_validator_detail.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto st663;
	} else if ( (*p) >= 33 )
...
st668:
	if ( ++p == pe )
		goto _test_eof668;
case 668:
#line 12033 "vcf_validator_detail.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto st669;
	} else if ( (*p) >= 33 )
...
st676:
	if ( ++p == pe )
		goto _test_eof676;
case 676:
#line 12085 "vcf_validator_detail.hpp"
	goto st0;
st673:
	if ( ++p == pe )
		goto _test_eof673;
...
st677:
	if ( ++p == pe )
		goto _test_eof677;
case 677:
#line 12107 "vcf_validator_detail.hpp"
	goto st0;
	}
...
#line 39 "vcf_v41.ragel"
	...
	break;
#line 13848 "vcf_validator_detail.hpp"
	}
	}
