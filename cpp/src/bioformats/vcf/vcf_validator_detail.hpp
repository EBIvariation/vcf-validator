...
st72:
	if ( ++p == pe )
		goto _test_eof72;
case 72:
#line 1030 "vcf_validator_detail.hpp"
	if ( 32 <= (*p) && (*p) <= 126 )
		goto tr83;
	goto tr37;
tr83:
...
st73:
	if ( ++p == pe )
		goto _test_eof73;
case 73:
#line 1044 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr84;
		case 10: goto tr85;
	}
...
st74:
	if ( ++p == pe )
		goto _test_eof74;
case 74:
#line 1104 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr88;
		case 44: goto st74;
		case 46: goto st74;
...
st75:
	if ( ++p == pe )
		goto _test_eof75;
case 75:
#line 1134 "vcf_validator_detail.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr91;
	goto tr90;
tr91:
...
st77:
	if ( ++p == pe )
		goto _test_eof77;
case 77:
#line 1170 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr95;
		case 95: goto tr96;
	}
...
st78:
	if ( ++p == pe )
		goto _test_eof78;
case 78:
#line 1194 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr97;
	goto tr94;
tr97:
...
st79:
	if ( ++p == pe )
		goto _test_eof79;
case 79:
#line 1212 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 65: goto tr99;
		case 67: goto tr99;
		case 71: goto tr99;
...
st80:
	if ( ++p == pe )
		goto _test_eof80;
case 80:
#line 1231 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr100;
		case 65: goto st80;
		case 67: goto st80;
...
st81:
	if ( ++p == pe )
		goto _test_eof81;
case 81:
#line 1255 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr103;
		case 48: goto tr104;
		case 60: goto tr105;
...
st82:
	if ( ++p == pe )
		goto _test_eof82;
case 82:
#line 1279 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr109;
		case 44: goto st102;
		case 46: goto st82;
...
st83:
	if ( ++p == pe )
		goto _test_eof83;
case 83:
#line 1349 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr113;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr114;
...
st84:
	if ( ++p == pe )
		goto _test_eof84;
case 84:
#line 1365 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr115;
	goto tr112;
tr115:
...
st85:
	if ( ++p == pe )
		goto _test_eof85;
case 85:
#line 1389 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr117;
		case 46: goto tr117;
		case 95: goto tr117;
...
st86:
	if ( ++p == pe )
		goto _test_eof86;
case 86:
#line 1414 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr118;
		case 44: goto st86;
		case 46: goto st86;
...
st87:
	if ( ++p == pe )
		goto _test_eof87;
case 87:
#line 1445 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr122;
		case 95: goto tr123;
	}
...
st88:
	if ( ++p == pe )
		goto _test_eof88;
case 88:
#line 1469 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr124;
		case 10: goto tr125;
		case 59: goto st94;
...
st90:
	if ( ++p == pe )
		goto _test_eof90;
case 90:
#line 1511 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr130;
		case 58: goto st93;
	}
...
st91:
	if ( ++p == pe )
		goto _test_eof91;
case 91:
#line 1549 "vcf_validator_detail.hpp"
	if ( 33 <= (*p) && (*p) <= 126 )
		goto tr134;
	goto tr133;
tr134:
...
st92:
	if ( ++p == pe )
		goto _test_eof92;
case 92:
#line 1563 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr135;
		case 10: goto tr136;
	}
...
st151:
	if ( ++p == pe )
		goto _test_eof151;
case 151:
#line 1645 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto tr192;
		case 46: goto tr192;
		case 95: goto tr192;
...
st95:
	if ( ++p == pe )
		goto _test_eof95;
case 95:
#line 1700 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr124;
		case 10: goto tr125;
		case 59: goto st94;
...
st99:
	if ( ++p == pe )
		goto _test_eof99;
case 99:
#line 1763 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr115;
		case 46: goto st100;
	}
...
st103:
	if ( ++p == pe )
		goto _test_eof103;
case 103:
#line 1810 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr109;
	goto tr102;
tr105:
...
st104:
	if ( ++p == pe )
		goto _test_eof104;
case 104:
#line 1824 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 67: goto st105;
		case 68: goto st109;
		case 73: goto st125;
...
st127:
	if ( ++p == pe )
		goto _test_eof127;
case 127:
#line 2017 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr109;
		case 44: goto st102;
		case 46: goto st82;
...
st137:
	if ( ++p == pe )
		goto _test_eof137;
case 137:
#line 2154 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto st138;
		case 46: goto st138;
		case 95: goto st138;
...
st143:
	if ( ++p == pe )
		goto _test_eof143;
case 143:
#line 2239 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 44: goto st144;
		case 46: goto st144;
		case 95: goto st144;
...
st147:
	if ( ++p == pe )
		goto _test_eof147;
case 147:
#line 2299 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr97;
		case 95: goto st147;
	}
...
st152:
	if ( ++p == pe )
		goto _test_eof152;
case 152:
#line 2333 "vcf_validator_detail.hpp"
	goto st0;
st149:
	if ( ++p == pe )
		goto _test_eof149;
...
st153:
	if ( ++p == pe )
		goto _test_eof153;
case 153:
#line 2355 "vcf_validator_detail.hpp"
	goto st0;
	}
...
#line 39 "vcf_v41.ragel"
	...
	break;
#line 2817 "vcf_validator_detail.hpp"
	}
	}
