...
st540:
	if ( ++p == pe )
		goto _test_eof540;
case 540:
#line 9688 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 65: goto tr578;
		case 67: goto tr578;
		case 71: goto tr578;
...
st542:
	if ( ++p == pe )
		goto _test_eof542;
case 542:
#line 9741 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 42: goto tr582;
		case 46: goto tr583;
		case 48: goto tr584;
...
st544:
	if ( ++p == pe )
		goto _test_eof544;
case 544:
#line 9847 "vcf_validator_detail.hpp"
	if ( (*p) == 46 )
		goto tr591;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr592;
...
st545:
	if ( ++p == pe )
		goto _test_eof545;
case 545:
#line 9863 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr593;
	goto tr590;
tr593:
...
st548:
	if ( ++p == pe )
		goto _test_eof548;
case 548:
#line 9926 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr600;
		case 49: goto tr602;
		case 65: goto tr603;
...
st550:
	if ( ++p == pe )
		goto _test_eof550;
case 550:
#line 9983 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto tr618;
		case 95: goto tr620;
	}
...
st552:
	if ( ++p == pe )
		goto _test_eof552;
case 552:
#line 10031 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr623;
		case 46: goto st552;
		case 58: goto st558;
...
st676:
	if ( ++p == pe )
		goto _test_eof676;
case 676:
#line 10170 "vcf_validator_detail.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto tr749;
	} else if ( (*p) >= 33 )
...
st564:
	if ( ++p == pe )
		goto _test_eof564;
case 564:
#line 10328 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr613;
		case 10: goto tr614;
		case 48: goto st565;
...
st590:
	if ( ++p == pe )
		goto _test_eof590;
case 590:
#line 10738 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr613;
		case 10: goto tr614;
		case 59: goto st560;
...
st601:
	if ( ++p == pe )
		goto _test_eof601;
case 601:
#line 10988 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr613;
		case 10: goto tr614;
		case 59: goto st560;
...
st603:
	if ( ++p == pe )
		goto _test_eof603;
case 603:
#line 11034 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr613;
		case 10: goto tr614;
		case 59: goto st560;
...
st604:
	if ( ++p == pe )
		goto _test_eof604;
case 604:
#line 11062 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr613;
		case 10: goto tr614;
		case 59: goto st560;
...
st610:
	if ( ++p == pe )
		goto _test_eof610;
case 610:
#line 11196 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 9: goto tr613;
		case 10: goto tr614;
		case 59: goto st560;
...
st624:
	if ( ++p == pe )
		goto _test_eof624;
case 624:
#line 11460 "vcf_validator_detail.hpp"
	if ( (*p) == 9 )
		goto tr694;
	goto tr581;
tr585:
...
st625:
	if ( ++p == pe )
		goto _test_eof625;
case 625:
#line 11474 "vcf_validator_detail.hpp"
	switch( (*p) ) {
		case 46: goto st626;
		case 67: goto st629;
		case 68: goto st632;
...
st662:
	if ( ++p == pe )
		goto _test_eof662;
case 662:
#line 11955 "vcf_validator_detail.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto st663;
	} else if ( (*p) >= 33 )
...
st668:
	if ( ++p == pe )
		goto _test_eof668;
case 668:
#line 12032 "vcf_validator_detail.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto st669;
	} else if ( (*p) >= 33 )
...
st677:
	if ( ++p == pe )
		goto _test_eof677;
case 677:
#line 12094 "vcf_validator_detail.hpp"
	goto st0;
st674:
	if ( ++p == pe )
		goto _test_eof674;
...
st678:
	if ( ++p == pe )
		goto _test_eof678;
case 678:
#line 12116 "vcf_validator_detail.hpp"
	goto st0;
	}
...
#line 45 "vcf_v41.ragel"
	...
	break;
#line 13859 "vcf_validator_detail.hpp"
	}
	}
