...
namespace ebi
{
  ...
  {
    /**
     * Reads until the end of line ('\n') or end of file ('\0'), and returns false if the file was entirely read.
     * To detect if the last line in the file does not end with a newline just before the end of file, the function
     * will return false, but the container will not be empty.
     *  ```
     ...
     * @return false if end of file was reached or an error occurred, true otherwise.
     * Even if false is returned, the container may have characters if there's no newline before the end of file.
     */
