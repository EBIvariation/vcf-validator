...
st665:
	if ( ++p == pe )
		goto _test_eof665;
case 665:
#line 12621 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 10: goto tr913;
		case 13: goto tr914;
		case 43: goto tr920;
...
st598:
	if ( ++p == pe )
		goto _test_eof598;
case 598:
#line 12700 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 43: goto tr847;
		case 59: goto tr847;
		case 62: goto tr848;
...
st600:
	if ( ++p == pe )
		goto _test_eof600;
case 600:
#line 12790 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 10 )
		goto st665;
	goto tr850;
tr919:
...
st601:
	if ( ++p == pe )
		goto _test_eof601;
case 601:
#line 12804 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) > 57 ) {
		if ( 59 <= (*p) && (*p) <= 126 )
			goto tr853;
	} else if ( (*p) >= 33 )
...
st667:
	if ( ++p == pe )
		goto _test_eof667;
case 667:
#line 12853 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 9: goto tr839;
		case 10: goto tr917;
		case 13: goto tr918;
...
st603:
	if ( ++p == pe )
		goto _test_eof603;
case 603:
#line 12936 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 48 )
		goto tr855;
	goto tr833;
tr855:
...
st604:
	if ( ++p == pe )
		goto _test_eof604;
case 604:
#line 12950 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 48 )
		goto tr856;
	goto tr833;
tr856:
...
st605:
	if ( ++p == pe )
		goto _test_eof605;
case 605:
#line 12964 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 71 )
		goto tr857;
	goto tr833;
tr857:
...
st606:
	if ( ++p == pe )
		goto _test_eof606;
case 606:
#line 12997 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 49: goto tr835;
		case 95: goto tr836;
	}
...
st607:
	if ( ++p == pe )
		goto _test_eof607;
case 607:
#line 13057 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr859;
	} else if ( (*p) >= 32 )
...
st608:
	if ( ++p == pe )
		goto _test_eof608;
case 608:
#line 13094 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 58 )
		goto tr826;
	if ( (*p) < 65 ) {
		if ( (*p) < 48 ) {
...
st609:
	if ( ++p == pe )
		goto _test_eof609;
case 609:
#line 13132 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 9: goto tr831;
		case 58: goto st591;
	}
...
st612:
	if ( ++p == pe )
		goto _test_eof612;
case 612:
#line 13201 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 43: goto tr861;
		case 45: goto tr861;
	}
...
st615:
	if ( ++p == pe )
		goto _test_eof615;
case 615:
#line 13259 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 110 )
		goto tr863;
	goto tr814;
tr863:
...
st622:
	if ( ++p == pe )
		goto _test_eof622;
case 622:
#line 13406 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 9: goto tr812;
		case 44: goto tr813;
		case 65: goto tr867;
...
st623:
	if ( ++p == pe )
		goto _test_eof623;
case 623:
#line 13436 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 42: goto tr869;
		case 61: goto tr868;
	}
...
st624:
	if ( ++p == pe )
		goto _test_eof624;
case 624:
#line 13478 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 61 )
		goto tr868;
	if ( (*p) < 63 ) {
		if ( (*p) < 45 ) {
...
st625:
	if ( ++p == pe )
		goto _test_eof625;
case 625:
#line 13518 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 62 )
		goto tr871;
	if ( (*p) < 45 ) {
		if ( 33 <= (*p) && (*p) <= 43 )
...
st626:
	if ( ++p == pe )
		goto _test_eof626;
case 626:
#line 13540 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 62 )
		goto tr871;
	if ( (*p) < 61 ) {
		if ( (*p) < 45 ) {
...
st629:
	if ( ++p == pe )
		goto _test_eof629;
case 629:
#line 13651 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 43: goto tr875;
		case 58: goto tr877;
		case 92: goto tr875;
...
st631:
	if ( ++p == pe )
		goto _test_eof631;
case 631:
#line 13693 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 91 )
		goto tr871;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr878;
...
st634:
	if ( ++p == pe )
		goto _test_eof634;
case 634:
#line 13769 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 58 )
		goto tr877;
	goto tr805;
tr874:
...
st635:
	if ( ++p == pe )
		goto _test_eof635;
case 635:
#line 13783 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 43: goto tr881;
		case 59: goto tr881;
		case 60: goto tr882;
...
st637:
	if ( ++p == pe )
		goto _test_eof637;
case 637:
#line 13843 "inc/vcf/validator_detail_v43.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr884;
	goto tr805;
tr884:
...
st642:
	if ( ++p == pe )
		goto _test_eof642;
case 642:
#line 13951 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 43: goto tr887;
		case 59: goto tr887;
		case 60: goto tr888;
...
st648:
	if ( ++p == pe )
		goto _test_eof648;
case 648:
#line 14101 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 58 )
		goto tr889;
	goto tr805;
tr811:
...
st652:
	if ( ++p == pe )
		goto _test_eof652;
case 652:
#line 14193 "inc/vcf/validator_detail_v43.hpp"
	if ( (*p) == 93 )
		goto tr891;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr897;
...
st659:
	if ( ++p == pe )
		goto _test_eof659;
case 659:
#line 14399 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 10: goto tr903;
		case 13: goto tr904;
	}
...
st660:
	if ( ++p == pe )
		goto _test_eof660;
case 660:
#line 14441 "inc/vcf/validator_detail_v43.hpp"
	switch( (*p) ) {
		case 10: goto tr906;
		case 13: goto tr907;
	}
...
st673:
	if ( ++p == pe )
		goto _test_eof673;
case 673:
#line 14465 "inc/vcf/validator_detail_v43.hpp"
	goto st0;
	}
