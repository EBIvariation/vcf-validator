...
static const int vcf_v42_first_final = 593;
static const int vcf_v42_error = 0;

static const int vcf_v42_en_main = 1;
static const int vcf_v42_en_main_meta_section = 28;
static const int vcf_v42_en_main_body_section = 597;
static const int vcf_v42_en_meta_section_skip = 591;
static const int vcf_v42_en_body_section_skip = 592;
...
st415:
	if ( ++p == pe )
		goto _test_eof415;
case 415:
#line 9068 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 95 )
		goto st415;
	if ( (*p) < 48 ) {
		if ( 45 <= (*p) && (*p) <= 46 )
...
st418:
	if ( ++p == pe )
		goto _test_eof418;
case 418:
#line 9162 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 44: goto tr577;
		case 62: goto tr578;
	}
...
st419:
	if ( ++p == pe )
		goto _test_eof419;
case 419:
#line 9183 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 10: goto tr55;
		case 13: goto tr56;
	}
...
st422:
	if ( ++p == pe )
		goto _test_eof422;
case 422:
#line 9248 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 44: goto st414;
		case 62: goto st419;
	}
...
st423:
	if ( ++p == pe )
		goto _test_eof423;
case 423:
#line 9274 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr595;
		case 92: goto tr592;
	}
...
st425:
	if ( ++p == pe )
		goto _test_eof425;
case 425:
#line 9336 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr591;
		case 47: goto tr590;
		case 92: goto tr592;
...
st426:
	if ( ++p == pe )
		goto _test_eof426;
case 426:
#line 9387 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr591;
		case 47: goto tr590;
		case 92: goto tr592;
...
st427:
	if ( ++p == pe )
		goto _test_eof427;
case 427:
#line 9438 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr591;
		case 47: goto tr590;
		case 61: goto tr602;
...
st428:
	if ( ++p == pe )
		goto _test_eof428;
case 428:
#line 9481 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr604;
		case 44: goto tr590;
		case 62: goto tr590;
...
st429:
	if ( ++p == pe )
		goto _test_eof429;
case 429:
#line 9511 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr591;
		case 44: goto tr607;
		case 62: goto tr608;
...
st430:
	if ( ++p == pe )
		goto _test_eof430;
case 430:
#line 9551 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 10: goto tr55;
		case 13: goto tr56;
		case 34: goto tr591;
...
st431:
	if ( ++p == pe )
		goto _test_eof431;
case 431:
#line 9581 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 34: goto tr595;
		case 44: goto tr607;
		case 62: goto tr608;
...
st433:
	if ( ++p == pe )
		goto _test_eof433;
case 433:
#line 9625 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 61: goto tr41;
		case 101: goto tr613;
	}
...
st434:
	if ( ++p == pe )
		goto _test_eof434;
case 434:
#line 9643 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 61: goto tr41;
		case 100: goto tr614;
	}
...
st435:
	if ( ++p == pe )
		goto _test_eof435;
case 435:
#line 9661 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 61: goto tr41;
		case 105: goto tr615;
	}
...
st436:
	if ( ++p == pe )
		goto _test_eof436;
case 436:
#line 9679 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 61: goto tr41;
		case 103: goto tr616;
	}
...
st437:
	if ( ++p == pe )
		goto _test_eof437;
case 437:
#line 9697 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 61: goto tr41;
		case 114: goto tr617;
	}
...
st438:
	if ( ++p == pe )
		goto _test_eof438;
case 438:
#line 9715 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 61: goto tr41;
		case 101: goto tr618;
	}
...
st443:
	if ( ++p == pe )
		goto _test_eof443;
case 443:
#line 9796 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 60 )
		goto st444;
	goto tr612;
st444:
...
st470:
	if ( ++p == pe )
		goto _test_eof470;
case 470:
#line 10113 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 80 )
		goto st471;
	goto tr647;
st471:
...
st474:
	if ( ++p == pe )
		goto _test_eof474;
case 474:
#line 10148 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 73 )
		goto st475;
	goto tr647;
st475:
...
st477:
	if ( ++p == pe )
		goto _test_eof477;
case 477:
#line 10176 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 82 )
		goto st478;
	goto tr647;
st478:
...
st485:
	if ( ++p == pe )
		goto _test_eof485;
case 485:
#line 10246 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 81 )
		goto st486;
	goto tr647;
st486:
...
st490:
	if ( ++p == pe )
		goto _test_eof490;
case 490:
#line 10288 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 70 )
		goto st491;
	goto tr647;
st491:
...
st510:
	if ( ++p == pe )
		goto _test_eof510;
case 510:
#line 10479 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr696;
		case 10: goto tr697;
		case 13: goto tr698;
...
st593:
	if ( ++p == pe )
		goto _test_eof593;
case 593:
#line 10528 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 10: goto tr821;
		case 13: goto tr822;
		case 60: goto tr824;
...
st594:
	if ( ++p == pe )
		goto _test_eof594;
case 594:
#line 10579 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 10: goto tr825;
		case 13: goto tr826;
	}
...
st511:
	if ( ++p == pe )
		goto _test_eof511;
case 511:
#line 10621 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 10 )
		goto st594;
	goto st0;
tr832:
...
st513:
	if ( ++p == pe )
		goto _test_eof513;
case 513:
#line 10706 "inc/vcf/validator_detail_v42.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr706;
	goto tr705;
tr706:
...
st514:
	if ( ++p == pe )
		goto _test_eof514;
case 514:
#line 10730 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 9 )
		goto tr707;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr708;
...
st515:
	if ( ++p == pe )
		goto _test_eof515;
case 515:
#line 10760 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr710;
	} else if ( (*p) >= 33 )
...
st516:
	if ( ++p == pe )
		goto _test_eof516;
case 516:
#line 10787 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr711;
		case 59: goto tr713;
	}
...
st519:
	if ( ++p == pe )
		goto _test_eof519;
case 519:
#line 10880 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 42: goto tr719;
		case 46: goto tr720;
		case 60: goto tr721;
...
st521:
	if ( ++p == pe )
		goto _test_eof521;
case 521:
#line 10943 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 43: goto tr728;
		case 45: goto tr728;
		case 46: goto tr729;
...
st522:
	if ( ++p == pe )
		goto _test_eof522;
case 522:
#line 10968 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 73 )
		goto tr734;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr733;
...
st524:
	if ( ++p == pe )
		goto _test_eof524;
case 524:
#line 11022 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 46: goto tr740;
		case 58: goto tr739;
	}
...
st526:
	if ( ++p == pe )
		goto _test_eof526;
case 526:
#line 11102 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr744;
		case 59: goto tr745;
	}
...
st530:
	if ( ++p == pe )
		goto _test_eof530;
case 530:
#line 11247 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 46 )
		goto tr757;
	if ( (*p) < 48 ) {
		if ( 33 <= (*p) && (*p) <= 47 )
...
st531:
	if ( ++p == pe )
		goto _test_eof531;
case 531:
#line 11374 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
			goto tr759;
	} else if ( (*p) > 90 ) {
...
st532:
	if ( ++p == pe )
		goto _test_eof532;
case 532:
#line 11404 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 59: goto tr760;
		case 62: goto tr761;
	}
...
st533:
	if ( ++p == pe )
		goto _test_eof533;
case 533:
#line 11428 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 9 )
		goto tr762;
	goto tr702;
tr830:
...
st598:
	if ( ++p == pe )
		goto _test_eof598;
case 598:
#line 11529 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr752;
		case 10: goto tr829;
		case 13: goto tr830;
...
st599:
	if ( ++p == pe )
		goto _test_eof599;
case 599:
#line 11551 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr752;
		case 10: goto tr829;
		case 13: goto tr830;
...
st536:
	if ( ++p == pe )
		goto _test_eof536;
case 536:
#line 11620 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 48 )
		goto tr767;
	goto tr746;
tr767:
...
st539:
	if ( ++p == pe )
		goto _test_eof539;
case 539:
#line 11662 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 71 )
		goto tr770;
	goto tr746;
tr770:
...
st602:
	if ( ++p == pe )
		goto _test_eof602;
case 602:
#line 11726 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr828;
		case 10: goto tr829;
		case 13: goto tr830;
...
st541:
	if ( ++p == pe )
		goto _test_eof541;
case 541:
#line 11755 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr772;
	} else if ( (*p) >= 33 )
...
st542:
	if ( ++p == pe )
		goto _test_eof542;
case 542:
#line 11792 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 58 )
		goto tr739;
	if ( (*p) < 65 ) {
		if ( (*p) < 48 ) {
...
st544:
	if ( ++p == pe )
		goto _test_eof544;
case 544:
#line 11866 "inc/vcf/validator_detail_v42.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr773;
	goto tr727;
tr773:
...
st547:
	if ( ++p == pe )
		goto _test_eof547;
case 547:
#line 11917 "inc/vcf/validator_detail_v42.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr775;
	goto tr727;
tr775:
...
st552:
	if ( ++p == pe )
		goto _test_eof552;
case 552:
#line 12013 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 97 )
		goto tr778;
	goto tr727;
tr778:
...
st557:
	if ( ++p == pe )
		goto _test_eof557;
case 557:
#line 12140 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 61 )
		goto tr781;
	if ( (*p) < 63 ) {
		if ( (*p) < 45 ) {
...
st559:
	if ( ++p == pe )
		goto _test_eof559;
case 559:
#line 12212 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr725;
		case 44: goto tr726;
		case 46: goto tr783;
...
st562:
	if ( ++p == pe )
		goto _test_eof562;
case 562:
#line 12287 "inc/vcf/validator_detail_v42.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr790;
	goto tr718;
tr790:
...
st563:
	if ( ++p == pe )
		goto _test_eof563;
case 563:
#line 12301 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 91 )
		goto tr783;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr790;
...
st571:
	if ( ++p == pe )
		goto _test_eof571;
case 571:
#line 12451 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
			goto tr797;
	} else if ( (*p) > 90 ) {
...
st575:
	if ( ++p == pe )
		goto _test_eof575;
case 575:
#line 12535 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 58: goto tr801;
		case 61: goto tr799;
	}
...
st579:
	if ( ++p == pe )
		goto _test_eof579;
case 579:
#line 12609 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 59: goto tr804;
		case 62: goto tr805;
	}
...
st581:
	if ( ++p == pe )
		goto _test_eof581;
case 581:
#line 12651 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 60 )
		goto tr807;
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
...
st585:
	if ( ++p == pe )
		goto _test_eof585;
case 585:
#line 12727 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
			goto tr810;
	} else if ( (*p) > 90 ) {
...
st586:
	if ( ++p == pe )
		goto _test_eof586;
case 586:
#line 12747 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 59: goto tr810;
		case 62: goto tr811;
	}
...
st588:
	if ( ++p == pe )
		goto _test_eof588;
case 588:
#line 12789 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr725;
		case 65: goto tr780;
		case 67: goto tr780;
...
st605:
	if ( ++p == pe )
		goto _test_eof605;
case 605:
#line 12959 "inc/vcf/validator_detail_v42.hpp"
	goto st0;
	}
...
#line 65 "src/vcf/vcf.ragel"
	...
	break;
#line 15249 "inc/vcf/validator_detail_v42.hpp"
	}
	}
