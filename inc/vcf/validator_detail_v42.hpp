...
st593:
	if ( ++p == pe )
		goto _test_eof593;
case 593:
#line 10536 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 10: goto tr821;
		case 13: goto tr822;
		case 60: goto tr824;
...
st594:
	if ( ++p == pe )
		goto _test_eof594;
case 594:
#line 10587 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 10: goto tr825;
		case 13: goto tr826;
	}
...
st512:
	if ( ++p == pe )
		goto _test_eof512;
case 512:
#line 10671 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr703;
		case 59: goto tr704;
		case 61: goto tr704;
...
st514:
	if ( ++p == pe )
		goto _test_eof514;
case 514:
#line 10738 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 9 )
		goto tr707;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr708;
...
st515:
	if ( ++p == pe )
		goto _test_eof515;
case 515:
#line 10768 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr710;
	} else if ( (*p) >= 33 )
...
st516:
	if ( ++p == pe )
		goto _test_eof516;
case 516:
#line 10795 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr711;
		case 59: goto tr713;
	}
...
st518:
	if ( ++p == pe )
		goto _test_eof518;
case 518:
#line 10855 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr716;
		case 65: goto tr717;
		case 67: goto tr717;
...
st521:
	if ( ++p == pe )
		goto _test_eof521;
case 521:
#line 10951 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 43: goto tr728;
		case 45: goto tr728;
		case 46: goto tr729;
...
st522:
	if ( ++p == pe )
		goto _test_eof522;
case 522:
#line 10976 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 73 )
		goto tr734;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr733;
...
st525:
	if ( ++p == pe )
		goto _test_eof525;
case 525:
#line 11066 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 58 )
		goto st525;
	if ( (*p) < 65 ) {
		if ( (*p) < 48 ) {
...
st527:
	if ( ++p == pe )
		goto _test_eof527;
case 527:
#line 11136 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 46: goto tr747;
		case 49: goto tr748;
		case 95: goto tr749;
...
st528:
	if ( ++p == pe )
		goto _test_eof528;
case 528:
#line 11193 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
			goto tr751;
	} else if ( (*p) > 90 ) {
...
st529:
	if ( ++p == pe )
		goto _test_eof529;
case 529:
#line 11223 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr752;
		case 58: goto tr754;
	}
...
st530:
	if ( ++p == pe )
		goto _test_eof530;
case 530:
#line 11255 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 46 )
		goto tr757;
	if ( (*p) < 48 ) {
		if ( 33 <= (*p) && (*p) <= 47 )
...
st596:
	if ( ++p == pe )
		goto _test_eof596;
case 596:
#line 11287 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr752;
		case 10: goto tr829;
		case 13: goto tr830;
...
st532:
	if ( ++p == pe )
		goto _test_eof532;
case 532:
#line 11412 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 59: goto tr760;
		case 62: goto tr761;
	}
...
st533:
	if ( ++p == pe )
		goto _test_eof533;
case 533:
#line 11436 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 9 )
		goto tr762;
	goto tr702;
tr830:
...
st600:
	if ( ++p == pe )
		goto _test_eof600;
case 600:
#line 11596 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr752;
		case 10: goto tr829;
		case 13: goto tr830;
...
st541:
	if ( ++p == pe )
		goto _test_eof541;
case 541:
#line 11763 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) > 58 ) {
		if ( 60 <= (*p) && (*p) <= 126 )
			goto tr772;
	} else if ( (*p) >= 33 )
...
st603:
	if ( ++p == pe )
		goto _test_eof603;
case 603:
#line 11780 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr828;
		case 10: goto tr829;
		case 13: goto tr830;
...
st544:
	if ( ++p == pe )
		goto _test_eof544;
case 544:
#line 11874 "inc/vcf/validator_detail_v42.hpp"
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr773;
	goto tr727;
tr773:
...
st545:
	if ( ++p == pe )
		goto _test_eof545;
case 545:
#line 11888 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 9: goto tr735;
		case 69: goto tr737;
		case 101: goto tr737;
...
st546:
	if ( ++p == pe )
		goto _test_eof546;
case 546:
#line 11907 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 43: goto tr774;
		case 45: goto tr774;
	}
...
st549:
	if ( ++p == pe )
		goto _test_eof549;
case 549:
#line 11965 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 110 )
		goto tr776;
	goto tr727;
tr776:
...
st552:
	if ( ++p == pe )
		goto _test_eof552;
case 552:
#line 12021 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 97 )
		goto tr778;
	goto tr727;
tr778:
...
st563:
	if ( ++p == pe )
		goto _test_eof563;
case 563:
#line 12309 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 91 )
		goto tr783;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr790;
...
st575:
	if ( ++p == pe )
		goto _test_eof575;
case 575:
#line 12543 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 58: goto tr801;
		case 61: goto tr799;
	}
...
st577:
	if ( ++p == pe )
		goto _test_eof577;
case 577:
#line 12581 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 91 )
		goto tr803;
	if ( 48 <= (*p) && (*p) <= 57 )
		goto tr802;
...
st586:
	if ( ++p == pe )
		goto _test_eof586;
case 586:
#line 12755 "inc/vcf/validator_detail_v42.hpp"
	switch( (*p) ) {
		case 59: goto tr810;
		case 62: goto tr811;
	}
...
st589:
	if ( ++p == pe )
		goto _test_eof589;
case 589:
#line 12860 "inc/vcf/validator_detail_v42.hpp"
	if ( (*p) == 10 )
		goto st593;
	goto tr687;
tr23:
...
st604:
	if ( ++p == pe )
		goto _test_eof604;
case 604:
#line 12933 "inc/vcf/validator_detail_v42.hpp"
	goto st0;
tr819:
#line 43 "src/vcf/vcf.ragel"
	{
