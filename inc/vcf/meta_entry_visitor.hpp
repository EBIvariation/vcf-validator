...
namespace ebi
{
  namespace vcf 
  {
        ...
        private:
            ...
            void check_info_predefined_type(std::map<std::string, std::string> & value,
                                            std::map<std::string, std::pair<std::string, std::string>> const & info_types) const;
            void check_info_predefined_number(std::map<std::string, std::string> & value,
                                              std::map<std::string, std::pair<std::string, std::string>> const & info_numbers) const;
            void check_format_predefined_type(std::map<std::string, std::string> & value,
                                              std::map<std::string, std::pair<std::string, std::string>> const & format_types) const;
            void check_format_predefined_number(std::map<std::string, std::string> & value,
