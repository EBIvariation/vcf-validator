...
namespace odb
{
  ...
  struct access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::extra_statement_cache_type
  {
    extra_statement_cache_type (
      sqlite::connection&,
      image_type&,
  ...
  access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::id_type
  access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::
  id (const id_image_type& i)
  {
    sqlite::database* db (0);
    ODB_POTENTIALLY_UNUSED (db);
  ...
  bool access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::
  grow (image_type& i,
        bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
    ...
    if (t[0UL])
    {
      i.tool_version_value.capacity (i.tool_version_size);
      grew = true;
    }
        ...
        sqlite::statement_kind sk)
  {
    ...
    if (sk != statement_update)
    {
      b[n].type = sqlite::image_traits<
        ::std::string,
        sqlite::id_text>::bind_value;
      b[n].buffer = i.tool_version_value.data ();
      b[n].size = &i.tool_version_size;
      b[n].capacity = i.tool_version_value.capacity ();
      b[n].is_null = &i.tool_version_null;
      n++;
    }
        ...
        sqlite::statement_kind sk)
  {
    ...
    if (sk == statement_insert)
    {
      ...
      bool is_null (false);
      std::size_t cap (i.tool_version_value.capacity ());
      sqlite::value_traits<
          ::std::string,
          sqlite::id_text >::set_image (
        i.tool_version_value,
        i.tool_version_size,
        is_null,
        v);
      i.tool_version_null = is_null;
      grew = grew || (cap != i.tool_version_value.capacity ());
    }
  ...
  const char access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::persist_statement[] =
  "INSERT INTO \"ToolVersion\" "
  "(\"tool_version\", "
  "\"id\") "
  "VALUES "
  "(?, ?)";

  const char access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::find_statement[] =
  "SELECT "
  "\"ToolVersion\".\"tool_version\", "
  "\"ToolVersion\".\"id\" "
  "FROM \"ToolVersion\" "
  "WHERE \"ToolVersion\".\"id\"=?";

  const char access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::erase_statement[] =
  "DELETE FROM \"ToolVersion\" "
  "WHERE \"id\"=?";

  const char access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::query_statement[] =
  "SELECT "
  "\"ToolVersion\".\"tool_version\", "
  "\"ToolVersion\".\"id\" "
  "FROM \"ToolVersion\"";

  const char access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::erase_query_statement[] =
  "DELETE FROM \"ToolVersion\"";

  const char access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::table_name[] =
  "\"ToolVersion\"";
  ...
  result< access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::object_type >
  access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::
  query (database&, const query_base_type& q)
  {
    using namespace sqlite;
  ...
  unsigned long long access::object_traits_impl< ::ebi::vcf::ToolVersion, id_sqlite >::
  erase_query (database&, const query_base_type& q)
  {
    using namespace sqlite;
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"ToolVersion\"");
      ...
      switch (pass)
      {
        case 1:
        {
          ...
          db.execute ("CREATE TABLE \"DuplicationError\" (\n"
                      ...
                      "    REFERENCES \"BodySectionError\" (\"id\")\n"
                      "    ON DELETE CASCADE)");
          db.execute ("CREATE TABLE \"ToolVersion\" (\n"
